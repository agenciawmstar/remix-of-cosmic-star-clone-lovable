  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "nebula-teal": "hsl(var(--nebula-teal))",
      ...
      boxShadow: {
        neon: "0 0 20px hsl(var(--primary) / 0.5), 0 0 40px hsl(var(--primary) / 0.3), 0 0 60px hsl(var(--primary) / 0.2)",
        "neon-subtle": "0 0 15px hsl(var(--primary) / 0.3), 0 0 30px hsl(var(--primary) / 0.15)",
      },
    },
  },
